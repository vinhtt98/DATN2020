...
public class BoxTransform : MonoBehaviour
{
    ...
    void OnEnable()
    {
        GameObject gameObject = GameObject.Find("GameManager").GetComponent<ObjectManager>().targetGameObject;
        targetGameObject = null;
        if (gameObject != null)
        {
            targetGameObject = gameObject.transform.GetChild(0).gameObject;
        }
